  ...
  return (
    <>
      <SEO
        ...
        description="LightingLuminol is a Minecraft game server based on Paper, aimed at repairing broken vanilla properties."
        keywords={[
          "luminolmc",
          "lightingluminol",
          "luminol",
        ...
        header={
          <>
            ...
            <span className="text-luminol-color-500">
              {t("software.lightingluminol.index.title.line2")}
            </span>
          </>
        }
        description={t("software.lightingluminol.index.description")}
      />
      <section
        id="why"
      ...
      >
        <div className="max-w-7xl mx-auto">
          <h2 className="font-semibold text-xl md:text-2xl px-6 lg:px-4">
            {t("software.lightingluminol.index.why.title")}
          </h2>
        ...
        <div className="flex flex-col gap-6 md:(flex-row-reverse gap-8) xl:gap-24 items-center">
          ...
          <div className="flex-1">
            <h2 className="font-semibold text-2xl md:text-4xl break-all">
              {t("software.lightingluminol.index.image.1.title")}
            </h2>
            <p className="md:(mt-6 text-xl) text-gray-900 dark:text-gray-100 mt-3">
              {t("software.lightingluminol.index.image.1.description")}
            </p>
            <div className="flex flex-row gap-4 mt-8">
              <Button variant="filled" href="/downloads/luminol" dense>
                {t("software.lightingluminol.index.button.downloads")}
              </Button>
              <Button
                variant="outlined"
                ...
                dense
              >
                {t("software.lightingluminol.index.button.documentation")}
              </Button>
            </div>
          </div>
        </div>
        <div className="flex flex-col gap-6 md:(flex-row gap-8) xl:gap-24 items-center">
          ...
          <div className="flex-1">
            <h2 className="font-semibold text-2xl md:text-4xl">
              {t("software.lightingluminol.index.image.2.title")}
            </h2>
            <p className="md:(mt-6 text-xl) text-gray-900 dark:text-gray-100 mt-3">
              {t("software.lightingluminol.index.image.2.description")}
            </p>
            <div className="flex flex-row gap-4 mt-8">
              <Button
                variant="filled"
                ...
                dense
              >
                {t("software.lightingluminol.index.button.discord")}
              </Button>
            </div>
          </div>
        </div>
