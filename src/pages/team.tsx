...
const Team: NextPage = () => {
  ...
  return (
    <>
      <SEO
        title={t("title.team")}
        description="认识一下 LuminolMC 背后的人们。"
        keywords={["luminolmc", "luminol", "minecraft", "team"]}
      />
      <header className="max-w-7xl flex flex-row mx-auto px-4 pt-32 pb-26 lg:(pt-48 pb-40) gap-16">
