...
import { getVersionBuildDownloadURL } from "@/lib/service/v1";
  ...
  <div className="flex flex-col gap-1">
    {builds &&
      builds
        ...
        .map((build) => (
          <div
            className="flex flex-row items-center hover:bg-luminol-color-100 dark:hover:bg-gray-900 px-4 py-2 rounded-lg transition-colors"
            key={build.build}
          >
